...
const lineages = [
  ...
  },
  {
    ...
    year: 1877,
    status: "確定",
    note: "北斗富美舘蕭府王爺信仰源自泉州富美宮;蕭府王爺為西漢太子太傅蕭望之(非瘟神),人稱阿爺公,與富美宮當地信徒稱呼相同;台灣此系廟宇多冠「富美」之名以明淵源;光緒3年(1877)建廟,縣歷史建築",
    source: "內政部臺灣宗教文化地圖(北斗富美舘);文化部國家文化資產網(歷史建築)",
    evidenceUrl: "https://taiwangods.moi.gov.tw/html/cultural/3_0011.aspx?i=315"
  },
  {
    id: 58,
    deity: "朱府千歲",
    fromExternalName: "漳州府漳浦縣京仔社(中國福建)",
    toTempleId: 70,
    relation: "分香",
    year: null,
    status: "待查",
