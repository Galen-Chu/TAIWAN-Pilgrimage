...
- [x] **源流連結**：分香/謁祖/承繼/法脈/輪祀關係線，十二個信仰網絡共 56 筆（媽祖/觀音/關聖帝君/玉皇/地藏/阿彌陀佛/齋教/文武大眾爺/五府千歲/池府千歲/清水祖師/玄天上帝），含外部源頭節點與 evidenceUrl 出處；各待查項見 CLAUDE.md
...
│   └── i18n.js             # 雙語切換
├── data/
│   ├── temples.js          # 精選廟宇節點（策展層，68 筆）
│   ├── lineage.js          # 源流連結資料（十二個信仰網絡，56 筆）
