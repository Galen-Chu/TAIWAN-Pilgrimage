...
- [x] **源流連結**：分香/謁祖關係線——媽祖 10 筆＋觀音（安海龍山寺系）3 筆＋關聖帝君 5 筆，含外部源頭節點與 evidenceUrl 出處；玉皇/地藏已收錄落地點節點（源流邊待策展）、阿彌陀佛待宗派脈絡策展
...
│   ├── lineage-layer.js    # 源流連結圖層（媽祖/觀音/關聖帝君）
...
│   └── i18n.js             # 雙語切換
├── data/
│   ├── temples.js          # 精選廟宇節點（策展層，33 筆）
│   ├── lineage.js          # 源流連結資料（媽祖 10＋觀音 3＋關聖帝君 5 筆）
