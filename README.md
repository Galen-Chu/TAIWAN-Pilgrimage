...
- [x] **源流連結**：分香/謁祖/承繼/法脈關係線——媽祖 10＋觀音 3＋關聖帝君 10＋玉皇 4＋地藏 2＋阿彌陀佛 4＋齋教 6＋文武大眾爺 1＋王爺（五府千歲）4＝44 筆，含外部源頭節點與 evidenceUrl 出處；各待查項見 CLAUDE.md
...
│   └── i18n.js             # 雙語切換
├── data/
│   ├── temples.js          # 精選廟宇節點（策展層，56 筆）
│   ├── lineage.js          # 源流連結資料（六大系統＋齋教＋文武大眾爺＋王爺，44 筆）
